/**
 * f2e-workflow-reload v1.0.0
 * Add liveReload to f2e-workflow v1.6.8
 * @fierayan <fengyan314@gmail.com>
 *
 * f2e-workflow v1.6.8
...
module.exports = function(grunt) {
    ...
    grunt.initConfig({
        ...
        compress: {
            main: {
                options: {
                    archive: 'proj-generator-f2e-' + 'release.zip' // 设置压缩包名称
                },
                files: [{
                        expand: true,
                        src: "**/*",
    ...
    grunt.registerTask('default', ['less:dev', 'copy:dev', 'clean:dev','connect','watch']);
